<div class="relative p-4 bg-white rounded-lg border dark:bg-gray-800 sm:p-5">
    ...
    <form action="/dashboard" method="POST">
        ...
        <div class="flex gap-2">
            ...
            <a href="/dashboard" class="mt-4 inline-flex items-center text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
                        Cancel
            </a>
        </div>
    </form>
